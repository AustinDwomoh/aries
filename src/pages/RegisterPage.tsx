...
import { Eye, EyeOff, UserPlus, Gamepad2, Crown, Trophy, Shield, Zap, Star } from 'lucide-react';
...
export const RegisterPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await register(formData.username, formData.email, formData.password, formData.first_name, formData.last_name);
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                ...
                />
                <label htmlFor="agree_terms" className="ml-2 block text-sm text-gray-300">
                  I agree to the{' '}
